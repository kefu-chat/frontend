(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    ? define("@shared/lib/ngx-emoji-mart/ngx-emoji", [
        "exports",
        "@angular/core",
        "@angular/common",
      ], factory)
    : ((global = global || self),
      factory(
        ...
        (global.ctrl["ngx-emoji-mart"] = global.ctrl["ngx-emoji-mart"] || {}),
  ...
  var DEFAULT_BACKGROUNDFN = function (set, sheetSize) {
  ...
  var EmojiService = /** @class */ (function () {
    ...
    EmojiService.prototype.uncompress = function (list) {
      ...
      this.emojis = list.map(function (emoji) {
        ...
        if (data.obsoletes) {
          ...
          if (f) {
            if (f.keywords) {
              data.keywords = __spread(data.keywords, f.keywords, [
                f.shortName,
              ]);
            } else {
        ...
        try {
          for (
            var _b = __values(data.shortNames), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var n = _c.value;
    ...
    EmojiService.prototype.getData = function (emoji, skin, set) {
      ...
      if (hasSkinVariations && skin && skin > 1 && set) {
        ...
        if (!variationData.hidden || !variationData.hidden.includes(set)) {
          ...
          emojiData = Object.assign(
            Object.assign({}, emojiData),
            variationData
          );
        }
    ...
    EmojiService.prototype.unifiedToNative = function (unified) {
      var codePoints = unified.split("-").map(function (u) {
        return parseInt("0x" + u, 16);
      });
      return String.fromCodePoint.apply(String, __spread(codePoints));
    };
    EmojiService.prototype.emojiSpriteStyles = function (
      sheet,
      set,
      size,
      sheetSize,
  ...
  EmojiService.ctorParameters = function () {
    return [];
  };
      ...
      if (this.isNative && data.unified && data.native) {
        ...
        if (data.spriteUrl && this.sheetRows && this.sheetColumns) {
          this.style = Object.assign(Object.assign({}, this.style), {
            ...
            backgroundSize:
              100 * this.sheetColumns + "% " + 100 * this.sheetRows + "%",
  ...
  EmojiComponent.ctorParameters = function () {
