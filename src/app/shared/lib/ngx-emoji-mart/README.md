...
[![npm](https://badge.fury.io/js/%40ctrl%2Fngx-emoji-mart.svg)](https://www.npmjs.org/package/@shared/lib/ngx-emoji-mart)
...
```sh
npm install @shared/lib/ngx-emoji-mart
```
...
| @shared/lib/ngx-emoji-mart | Angular |
| -------------------- | ------- |
| 0.17.0               | 6.x 7.x |
| 1.0.6                | 8.x     |
| 3.1.0                | 9.x     |
...
```scss
@import '~@shared/lib/ngx-emoji-mart/picker';
```
...
"styles": [
  "styles.scss",
  "node_modules/@shared/lib/ngx-emoji-mart/picker.css"
]
```
...
```ts
import { EmojiSearch } from '@shared/lib/ngx-emoji-mart';
class ex {
